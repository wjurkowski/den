...
foreach my $lin(@motifs){
	...
	if($mottype==401){
		...
		if(($g1==2) || ($g2==2) || ($g3 ==2) || ($g3 ==2)){$state="UNCERTAIN";}
	}
	if($mottype==402){
		if(($g1==1) && ($g2==1) && ($g3 ==1) && ($g4 ==0)){$state="VALID";}
		if(($g1==0) && ($g2==0) && ($g3 ==0) && ($g4 ==1)){$state="VALID";}
		if(($g1==2) || ($g2==2) || ($g3 ==2) || ($g4 ==2)){$state="UNCERTAIN";}
	}
	if($mottype==403){
		if(($g1==0) && ($g2==1) && ($g3 ==1) && ($g4 ==1)){$state="VALID";}
		if(($g1==0) && ($g2==0) && ($g3 ==0) && ($g4 ==0)){$state="VALID";}
		if(($g1==2) || ($g2==2) || ($g3 ==2) || ($g4 ==2)){$state="UNCERTAIN";}
	}
	if($mottype==404){
